...
ADDOBJ= fsInit.o directoryEntry.o freeSpaceManager.o parsePath.o fs_isFile.o fs_isDir.o fs_mkdir.o fs_opendir.o fs_readdir.o fs_closedir.o fs_setcwd.o fs_getcwd.o fs_delete.o fs_rmdir.o fs_stat.o
ARCH = $(shell uname -m)
